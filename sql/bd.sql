...
CREATE TABLE votos(
    id_votos          int(11) AUTO_INCREMENT not null,
    ...
    CONSTRAINT pk_votos PRIMARY KEY(id_votos)     
);
...
CREATE TABLE comunas (
  ...
  CONSTRAINT pk_regiones PRIMARY KEY (comuna_id)
);

---CREACION TABLA CANDIDATOS-----

CREATE TABLE candidatos (
  candidato_id       int(11) NOT NULL AUTO_INCREMENT,
  candidato_nombre   varchar(64) NOT NULL, 
  CONSTRAINT pk_candidato PRIMARY KEY (candidato_id)
);
...
INSERT INTO comunas (comuna_id, comuna_nombre, region_id)
VALUES
	(1,'Arica',1),
	(2,'Camarones',1),
	(3,'General Lagos',1),
...
INSERT INTO candidatos (candidato_id,candidatos_nombre)
VALUES
	(1,'Gabriel Boric'),
    (2,'José Antonio Kast');