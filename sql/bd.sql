...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2023 a las 09:24:38
...
CREATE TABLE `candidatos` (
  ...
  `candidato_nombre` varchar(64) NOT NULL
...
INSERT INTO `candidatos` (`candidato_id`, `candidato_nombre`) VALUES
(1, 'Gabriel Boric'),
(2, 'José Antonio Kast');
...
--
ALTER TABLE `votos`
  MODIFY `id_votos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
